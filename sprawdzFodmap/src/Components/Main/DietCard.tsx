  ...
  return (
    <Paper className="diet-card" tabIndex={0}>
      <header>
        ...
        {notes && (
          <InfoTip title={<Fragment>{<span>{notes}</span>}</Fragment>}>
                        ...
                        <Fragment>
                          {
                            <span>
                              ...
                              FODMAPów - dozwolony na diecie low FODMAP
                            </span>
                          }
                        </Fragment>
                      }
                        ...
                        <Fragment>
                          {
                            <span>
                              Produkt o{" "}
                              <b style={{ color: amber[500] }}>
                                średniej zawartości
                              </b>{" "}
                              FODMAPów - dozwolony na diecie moderate FODMAP
                            </span>
                          }
                        </Fragment>
                      }
                        ...
                        <Fragment>
                          {
                            <span>
                              ...
                              FODMAPów - niewskazany w czasie trwania diety
                            </span>
                          }
                        </Fragment>
                      }
                ...
                {histamine && (
                  <ElementTip
                    title={
                      <Fragment>
                        {histamine == ">60%" && (
                          <span>
                            Produkt <b>zakazany w większości diet</b>{" "}
                            stosowanych przy Nietolerancji Histaminy
                          </span>
                        )}
                        {histamine == "20-60%" && (
                          <span>
                            Produkt <b>zakazany w istotnej części diet</b>{" "}
                            stosowanych przy Nietolerancji Histaminy
                          </span>
                        )}
                        {histamine == "20%" && (
                          <span>
                            Produkt <b>zakazany w niektórych dietach</b>{" "}
                            stosowanych przy Nietolerancji Histaminy
                          </span>
                        )}
                      </Fragment>
                  ...
                  >
                    <div className="histamine-div">
                      ...
                      {histamine !== "20-60%" ? (
                        <span className="histamine-non-mid-nums">
                          ({histamine})
                        </span>
                      ) : (
                        <span className="histamine-mid-nums">
                          ({histamine})
                        </span>
                      )}
                    </div>
