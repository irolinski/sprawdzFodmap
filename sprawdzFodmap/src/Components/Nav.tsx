    ...
    <nav>
      <Box sx={{ flexGrow: 1 }}>
        ...
        >
          <Toolbar>
            <Link
              aria-label={"logo - link do strony głównej"}
            ...
            <div className="nav-buttons-div">
              ...
              >
                <MenuItem
                  onClick={handleCloseDropdown1}
                  component="a"
                  href="/#/fodmap"
                  aria-label="diety low fodmap"
                >
                  d. Low FODMAP
                </MenuItem>
                <MenuItem
                  ...
                  component="a"
                  href="/#/hit"
                  aria-label="diety przeciwhistaminowe"
                >
                  d. Przeciwhistaminowe
                </MenuItem>
                <Divider />
                <MenuItem onClick={handleCloseDropdown1} component="a" href="/">
                  Szukaj
                </MenuItem>
              </Menu>
              <Button
